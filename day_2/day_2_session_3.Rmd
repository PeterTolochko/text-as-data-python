...
For this tasks, we will work a last time with an example text data, headlines from news articles about migration. The data set is a subset of the [REMINDER media corpus](https://doi.org/10.11587/IEGQ1B).
...
```{r}
articles_en <- read.csv("https://raw.githubusercontent.com/fabiennelind/text-as-data-in-R/main/data/articles_en.csv")
```
